...
제1조(목적)
이 약관은 T I N C(이하 "단체"라 한다) 홈페이지(www.TINC.com)에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. 
...
ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 이메일 , 서비스 이용기록 , 접속 로그 , 쿠키 , 접속 IP 정보
